<?php
    ...
    define( 'K_DB_NAME', 'mungari' );
    // 5.
    // Database username
    define( 'K_DB_USER', 'albert' );
    // 6.
    // Database password
    define( 'K_DB_PASSWORD', 'mwangi' );
    // 7.
    ...
    define( 'K_EMAIL_TO', 'ndirangu.mepawa@outlook.com' );

    // 14.
    // Will be used as the sender of messages delivered by contact forms to the address above.
    define( 'K_EMAIL_FROM', 'ndirangu.mepawa@gmail.com' );
